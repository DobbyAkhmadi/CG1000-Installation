...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_util_test_process" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#b9b88d39#;
   pragma Export (C, u00001, "util_test_processB");
   ...
   u00116 : constant Version_32 := 16#0f9783a4#;
   pragma Export (C, u00116, "system__val_intB");
   u00117 : constant Version_32 := 16#f3ca8567#;
   pragma Export (C, u00117, "system__val_intS");
   u00118 : constant Version_32 := 16#383fd226#;
   pragma Export (C, u00118, "system__val_unsB");
   u00119 : constant Version_32 := 16#47b5ed3e#;
